...
Copy kode di bawah ini dan paste ke file `Code.gs` di Apps Script Editor.
...
function updateStock(sku, quantity, type) {
  try {
    ...
    if (stokBaru <= minStok && stokBaru > 0) {
      ...
      const namaProduk = existingData.nama || "Produk SKU " + sku;
...
## 📋 Panduan Paste ke Apps Script

### Step 1: Buat File `Code.gs`
1. Buka Google Sheet yang sudah di-copy
2. Klik **Extensions > Apps Script**
3. Klik **File > New > Script**
4. Name: `Code.gs`

### Step 2: Paste Kode
1. Copy semua kode di atas (blok code)
2. Paste ke file `Code.gs`
3. Simpan (Ctrl+S)

### Step 3: Verifikasi
1. Cek apakah tidak ada error merah di editor
2. Klik **Run** untuk test function `doGet()`
3. Cek **Execution Log** di bawah (harusnya tidak ada error)

### Step 4: Deploy
1. Klik **Deploy > New Deployment**
2. Konfigurasi seperti panduan di file `README.md`
3. Deploy dan copy URL
